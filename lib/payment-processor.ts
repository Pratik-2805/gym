    ...
    await db.$transaction(async (tx: any) => {
      ...
      await tx.notification.create({
        data: {
          ...
          message: `Dear ${transaction.member.name}, your membership for ${transaction.plan.name} has been successfully activated! Expiry: ${endDate.toLocaleDateString('en-IN')}. Thank you!`,
          type: 'ACTIVATION',
          status: 'SENT',
        },
      });
